            ...
            if (file.exists()) {
                if (file.isFile()) {
                    if (false == file.delete()) {
                        Clog.e("imageutils", "saveImageFile delete fail");
                        return path;
                    }
                } else {
                    Clog.e("imageutils", "saveImageFile folder err");
                    return path;
                }
            }
            file.createNewFile();
...
//    }
    ...
    public static Bitmap geAutoRotatedBitmap(String filename, int height, int weight) {
        ...
        Clog.e("imageutils", "height|weight:" + height + "|" + weight);
        ...
        try {
            ...
            Clog.e("imageutils", "orientation:" + orientation);
            int degree = 0;
            switch (orientation) {
                case ExifInterface.ORIENTATION_ROTATE_90:
                    degree = 90;
            ...
            if (degree > 0) {
                ...
                Clog.e("imageutils", " try to rotate, orientation:" + orientation);
            }
        } catch (IOException e) {
    ...
    private Bitmap blurImageAmeliorate(Bitmap bmp) {
        ...
        Clog.e("may", "used time=" + (end - start));
        return bitmap;
    }
