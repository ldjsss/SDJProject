...
public class Frament_Activity extends BaseFragment implements LRecyclerView.LScrollListener {
    ...
    private List<ActivityBean.ActivityMode> alist = new ArrayList<>();
...
//        Log.e("currentPosition", "selectView currentPosition===" + position);
    ...
    private void getMatchData() {
        ...
        if(this.ViewType == 1) {
            HttpMsg.getInstance().sendActivity(SharePreUtils.getToken(getContext()), ActivityBean.class, new HttpMsg.Listener() {
                @Override
