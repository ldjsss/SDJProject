...
import com.lldj.tc.match.Fragment_Main;
...
public class Activity_Records extends BaseActivity {
    ...
    protected void initData() {
        ...
        toolbarTitleTv.setText(getResources().getString(R.string.recordTitle));
        initViewPager();
    }
...
//        AppUtils.reduceMarginsInTabs(recordtabLayout, 100);
    ...
    class Adapter_RecordPager extends FragmentStatePagerAdapterCompat {
        ...
        public Adapter_RecordPager(Context context, FragmentManager fm) {
            ...
            mTitle = new String[]{mResources.getString(R.string.notpay), mResources.getString(R.string.havepay)};
        ...
        private void setUpFragments() {
            ...
            for (int i = 0; i < mTitle.length; i++) {
                Frament_Record fragment = new Frament_Record();
