...
public class ScanCamera extends Activity implements Callback, PreviewCallback {
        ...
        this.flash.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (!getPackageManager().hasSystemFeature("android.hardware.camera.flash")) {
                    Toast.makeText(ScanCamera.this, ScanCamera.this.getResources().getString(getResources().getIdentifier("toast_flash", "string", getApplication().getPackageName())), Toast.LENGTH_SHORT).show();
                } else if (camera != null) {
    ...
    private void initCamera(SurfaceHolder holder) {
        ...
        if (!this.isROI) {
            ...
            this.isROI = true;
            if (this.isFatty) {
                this.myView = new ViewfinderView(ScanCamera.this, this.width, this.height, this.isFatty);
            } else {
                this.myView = new ViewfinderView(ScanCamera.this, this.width, this.height);
            }
